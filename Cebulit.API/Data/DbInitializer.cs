    ...
    public static class DbInitializer
    {
        public static void Initialize(DataContext context)
        {
            ...
            var buildsTagMatches = new[]
            {
                ...
                new Build.BuildTagMatch {BuildId = 1, Tag = tags[2], MatchLevel = 1.2},
                new Build.BuildTagMatch {BuildId = 1, Tag = tags[3], MatchLevel = 0.3},
                new Build.BuildTagMatch {BuildId = 1, Tag = tags[4], MatchLevel = 1.4},
                new Build.BuildTagMatch {BuildId = 1, Tag = tags[6], MatchLevel = 0.5},
                new Build.BuildTagMatch {BuildId = 1, Tag = tags[7], MatchLevel = 0.3},
                ...
                new Build.BuildTagMatch {BuildId = 2, Tag = tags[6], MatchLevel = 0.8},
                ...
                new Build.BuildTagMatch {BuildId = 2, Tag = tags[10], MatchLevel = 0.8},
                new Build.BuildTagMatch {BuildId = 3, Tag = tags[0], MatchLevel = 1.5},
                new Build.BuildTagMatch {BuildId = 3, Tag = tags[1], MatchLevel = 1.5},
                new Build.BuildTagMatch {BuildId = 3, Tag = tags[3], MatchLevel = 1.5},
                new Build.BuildTagMatch {BuildId = 3, Tag = tags[6], MatchLevel = 1.5},
                new Build.BuildTagMatch {BuildId = 3, Tag = tags[7], MatchLevel = 0.6},
                new Build.BuildTagMatch {BuildId = 3, Tag = tags[10], MatchLevel = 1},
                new Build.BuildTagMatch {BuildId = 4, Tag = tags[0], MatchLevel = 1.3},
                new Build.BuildTagMatch {BuildId = 4, Tag = tags[1], MatchLevel = 1.3},
                ...
                new Build.BuildTagMatch {BuildId = 5, Tag = tags[0], MatchLevel = 1.1},
                new Build.BuildTagMatch {BuildId = 5, Tag = tags[1], MatchLevel = 1.1},
                new Build.BuildTagMatch {BuildId = 5, Tag = tags[3], MatchLevel = 1.9},
                new Build.BuildTagMatch {BuildId = 5, Tag = tags[5], MatchLevel = 1.8},
                new Build.BuildTagMatch {BuildId = 5, Tag = tags[6], MatchLevel = 1.9},
                ...
                new Build.BuildTagMatch {BuildId = 7, Tag = tags[0], MatchLevel = 1.1},
                new Build.BuildTagMatch {BuildId = 7, Tag = tags[1], MatchLevel = 1.49},
                new Build.BuildTagMatch {BuildId = 7, Tag = tags[2], MatchLevel = 1.49},
